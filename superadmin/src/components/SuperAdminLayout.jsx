...
const SuperAdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/module-management', icon: Package, label: 'Module Management' },
    { path: '/sidebar-management', icon: PanelLeft, label: 'Sidebar Management' },
    { path: '/column-management', icon: Table, label: 'Column Management' },
  ];
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-primary font-medium">Super Admin Panel</span>
              </div>
            </div>
          </div>
          <button
